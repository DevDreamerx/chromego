...
# 尝试从第一个URL下载配置
download_config "https://www.gitlabip.xyz/Alvin9999/pac2/master/xray/3/config.json"

# 尝试从第二个URL下载配置
download_config "https://gitlab.com/free9999/ipupdate/-/raw/master/xray/2/config.json"
