...
# 尝试从第一个URL下载配置
download_config "https://www.gitlabip.xyz/Alvin9999/pac2/master/hysteria2/1/config.json"

# 尝试从第二个URL下载配置
download_config "https://gitlab.com/free9999/ipupdate/-/raw/master/hysteria2/config.json"
