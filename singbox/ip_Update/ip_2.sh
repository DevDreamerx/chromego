...
# 尝试从第一个URL下载配置
download_config "https://www.githubip.xyz/Alvin9999/pac2/master/singbox/config.json"

# 尝试从第二个URL下载配置
download_config "https://fastly.jsdelivr.net/gh/Alvin9999/pac2@latest/singbox/config.json"
